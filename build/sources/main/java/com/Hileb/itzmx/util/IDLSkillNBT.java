...
import com.Hileb.itzmx.item.skills.ItemSkillBase;
...
import static com.Hileb.itzmx.util.CommonDef.INT_AS_FLOAT;
import static com.Hileb.itzmx.util.NBTStrDef.IDLNBTDef.*;
import static com.Hileb.itzmx.util.NBTStrDef.IDLNBTUtil.*;
    ...
    public static void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag,
        ...
        if (shiftPressed)
        {
            ...
            if (showGuaSocketDesc)
            {
                ...
                if (guaTotal > 0)
                {
                    tooltip.add(I18n.format("itzmx.gua_enhance_list.desc", GetGuaEnhanceString(stack, 0),
            ...
            tooltip.add(TextFormatting.AQUA +  I18n.format("itzmx.shared.press_shift"));
            if (use_flavor)
            {
