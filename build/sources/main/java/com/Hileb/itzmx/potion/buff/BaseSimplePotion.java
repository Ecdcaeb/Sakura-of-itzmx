package com.Hileb.itzmx.potion.buff;
...
public class BaseSimplePotion extends Potion {
    protected static final ResourceLocation resource = new ResourceLocation("itzmx","textures/misc/potions.png");
...
//    }
    ...
    public BaseSimplePotion(boolean isBadEffectIn, int liquidColorIn, String name, int icon) {
        ...
        setPotionName("itzmx.potion." + name);
        iconIndex = icon;
    }
