package com.Hileb.itzmx.item.misc;

import com.Hileb.itzmx.item.IGuaEnhance;
import com.Hileb.itzmx.item.ItemSwordBase;
import com.Hileb.itzmx.util.IDLGeneral;
...
import static com.Hileb.itzmx.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.Hileb.itzmx.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.Hileb.itzmx.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.Hileb.itzmx.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.Hileb.itzmx.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
