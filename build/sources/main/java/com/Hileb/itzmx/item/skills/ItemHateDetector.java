...
import static com.Hileb.itzmx.util.NBTStrDef.IDLNBTDef.STATE;
import static com.Hileb.itzmx.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.Hileb.itzmx.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "itzmx.msg.being_targeted";
