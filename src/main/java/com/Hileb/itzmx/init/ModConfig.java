...
public class ModConfig {
    ...
    @Config.LangKey("configgui.itzmx.category.Menu0.GeneralConf")
...
//        @Config.LangKey("itzmx.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "itzmx.msg.welcome";
    }

    @Config.LangKey("configgui.itzmx.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.itzmx.category.Menu0.SpawnConf")
