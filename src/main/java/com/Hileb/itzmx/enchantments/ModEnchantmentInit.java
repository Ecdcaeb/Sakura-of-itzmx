package com.Hileb.itzmx.enchantments;
...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("itzmx.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
//            .setMaxLevel(10).setValue(0.3f, 0.3f);
    //附魔
    public static final ModEnchantmentBase ENCH_AROMATIC = new ModEnchantmentBase("itzmx.aromatic", Enchantment.Rarity.VERY_RARE, EnumEnchantmentType.WEAPON,  mainHand)
            .setMaxLevel(10).setValue(0.3f, 0.3f);
    public static final ModEnchantmentBase ENCH_RAINBOW = new ModEnchantmentBase("itzmx.rainbow", Enchantment.Rarity.VERY_RARE, EnumEnchantmentType.WEAPON,  mainHand)
            .setMaxLevel(1).setValue(0.3f, 0.3f);

//    public static final ModEnchantmentBase ENCH_COPY = new ModEnchantmentBase("itzmx.copy", Enchantment.Rarity.VERY_RARE, EnumEnchantmentType.WEAPON,  mainHand)
