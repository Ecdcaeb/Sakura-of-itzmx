...
public class ModBlocks {
	...
	public static final Block BLOCK_RAINBOW = new BlockBase("block_rainbow", Material.GOURD,new ItemInformationAdder("tile.block_rainbow.desc","tile.block_rainbow.desc")).setCreativeTab(ModCreativeTab.IDL_MISC).setHardness(50f);
//
